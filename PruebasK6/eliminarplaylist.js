...
export default function () {
  ...
  const url = 'https://localhost:7083/Playlist/EliminarPlaylist';
  ...
  check(res, {
    'playlist eliminada correctamente': (r) =>
      r.status === 200 || r.status === 302 || r.body.includes('¡Playlist eliminada exitosamente!'),
  });
}
